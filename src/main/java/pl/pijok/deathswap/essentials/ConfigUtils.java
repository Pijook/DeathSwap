package pl.pijok.deathswap.essentials;
...
public class ConfigUtils {
    ...
    public static void save(YamlConfiguration c, String file) {
        try {
            c.save(new File(DeathSwap.getInstance().getDataFolder(), file));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void save(YamlConfiguration c, String folder, String file){
        try {
            c.save(new File(DeathSwap.getInstance().getDataFolder() + File.separator + folder, file));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
